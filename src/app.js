...
const modules = [
  ...
  ["/coupons", "./modules/coupon/coupon.routes"],
  ["/banners", "./modules/banner/banner.routes"],
  ["/settings", "./modules/settings/settings.routes"],
  ["/shipping", "./modules/shipping/shipping.routes"],
